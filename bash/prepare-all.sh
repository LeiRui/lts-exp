...
$HOME_PATH/tool.sh DATA_MAX_TIME 140380000 run-efficiency-exp.sh  # TODO check this incremental t!!!
...
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-efficiency-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-efficiency-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 170990000 run-efficiency-exp.sh  # TODO check this incremental t!!!
...
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-efficiency-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-efficiency-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 307190000 run-efficiency-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 307190000 run-efficiency-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-efficiency-exp.sh #要写半小时
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-efficiency-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-efficiency-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-efficiency-exp.sh
...
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-efficiency-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-efficiency-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 191380000 run-efficiency-exp.sh  # TODO check this incremental t!!!
...
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-efficiency-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-efficiency-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 359994000 run-efficiency-exp.sh  # TODO check this incremental t!!!
...
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-efficiency-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-efficiency-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 180580000 run-efficiency-exp.sh  # TODO check this incremental t!!!
...
$HOME_PATH/tool.sh DATASET Wine_TEST run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Wine" run-scalability-exp.sh # TODO check this
...
$HOME_PATH/tool.sh DATA_MAX_TIME 140380000 run-scalability-exp.sh  # TODO check this incremental t!!!
...
cp run-scalability-exp.sh run-Wine_TEST-scalability-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-scalability-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-scalability-exp.sh
$HOME_PATH/tool.sh DATASET OliveOil_TEST run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.OliveOil" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-scalability-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-scalability-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-scalability-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 170990000 run-scalability-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 170990000 run-scalability-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-scalability-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-scalability-exp.sh
cp run-scalability-exp.sh run-OliveOil_TEST-scalability-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-scalability-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-scalability-exp.sh
$HOME_PATH/tool.sh DATASET Mallat_TEST run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Mallat" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-scalability-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-scalability-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-scalability-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 307190000 run-scalability-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 307190000 run-scalability-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-scalability-exp.sh #要写半小时
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-scalability-exp.sh
cp run-scalability-exp.sh run-Mallat_TEST-scalability-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-scalability-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-scalability-exp.sh
$HOME_PATH/tool.sh DATASET Lightning7_TEST run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Lightning7" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-scalability-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-scalability-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-scalability-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 191380000 run-scalability-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 191380000 run-scalability-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-scalability-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-scalability-exp.sh
cp run-scalability-exp.sh run-Lightning7_TEST-scalability-exp.sh  # TODO check this
...
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-scalability-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-scalability-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 359994000 run-scalability-exp.sh  # TODO check this incremental t!!!
...
cp $TRI_VISUALIZATION_EXP/bash/run-scalability-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-scalability-exp.sh
$HOME_PATH/tool.sh DATASET FreezerRegularTrain_TEST run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.FreezerRegularTrain" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-scalability-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-scalability-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-scalability-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-scalability-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 180580000 run-scalability-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 180580000 run-scalability-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-scalability-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-scalability-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-scalability-exp.sh
cp run-scalability-exp.sh run-FreezerRegularTrain_TEST-scalability-exp.sh  # TODO check this
...
$HOME_PATH/tool.sh DATASET Wine_TEST run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Wine" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-ablation-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-ablation-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-ablation-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 140380000 run-ablation-exp.sh  # TODO check this incremental t!!!
...
cp run-ablation-exp.sh run-Wine_TEST-ablation-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-ablation-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-ablation-exp.sh
$HOME_PATH/tool.sh DATASET OliveOil_TEST run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.OliveOil" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-ablation-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-ablation-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-ablation-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 170990000 run-ablation-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 170990000 run-ablation-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-ablation-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-ablation-exp.sh
cp run-ablation-exp.sh run-OliveOil_TEST-ablation-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-ablation-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-ablation-exp.sh
$HOME_PATH/tool.sh DATASET Mallat_TEST run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Mallat" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-ablation-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-ablation-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-ablation-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 307190000 run-ablation-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 307190000 run-ablation-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-ablation-exp.sh #要写半小时
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-ablation-exp.sh
cp run-ablation-exp.sh run-Mallat_TEST-ablation-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-ablation-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-ablation-exp.sh
$HOME_PATH/tool.sh DATASET Lightning7_TEST run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Lightning7" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-ablation-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-ablation-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-ablation-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 191380000 run-ablation-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 191380000 run-ablation-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-ablation-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-ablation-exp.sh
cp run-ablation-exp.sh run-Lightning7_TEST-ablation-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-ablation-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-ablation-exp.sh
$HOME_PATH/tool.sh DATASET HouseTwenty_TEST run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.HouseTwenty" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-ablation-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-ablation-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-ablation-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 359994000 run-ablation-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 359994000 run-ablation-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-ablation-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-ablation-exp.sh
cp run-ablation-exp.sh run-HouseTwenty_TEST-ablation-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-ablation-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-ablation-exp.sh
$HOME_PATH/tool.sh DATASET FreezerRegularTrain_TEST run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.FreezerRegularTrain" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-ablation-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-ablation-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-ablation-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-ablation-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 180580000 run-ablation-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 180580000 run-ablation-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-ablation-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-ablation-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-ablation-exp.sh
cp run-ablation-exp.sh run-FreezerRegularTrain_TEST-ablation-exp.sh  # TODO check this
...
$HOME_PATH/tool.sh DATASET Wine_TEST run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Wine" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-overhead-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-overhead-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-overhead-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 140380000 run-overhead-exp.sh  # TODO check this incremental t!!!
...
cp run-overhead-exp.sh run-Wine_TEST-overhead-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-overhead-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-overhead-exp.sh
$HOME_PATH/tool.sh DATASET OliveOil_TEST run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.OliveOil" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-overhead-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-overhead-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-overhead-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 170990000 run-overhead-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 170990000 run-overhead-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-overhead-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-overhead-exp.sh
cp run-overhead-exp.sh run-OliveOil_TEST-overhead-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-overhead-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-overhead-exp.sh
$HOME_PATH/tool.sh DATASET Mallat_TEST run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Mallat" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-overhead-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-overhead-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-overhead-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 307190000 run-overhead-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 307190000 run-overhead-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-overhead-exp.sh #要写半小时
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-overhead-exp.sh
cp run-overhead-exp.sh run-Mallat_TEST-overhead-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-overhead-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-overhead-exp.sh
$HOME_PATH/tool.sh DATASET Lightning7_TEST run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.Lightning7" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-overhead-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-overhead-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-overhead-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 191380000 run-overhead-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 191380000 run-overhead-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-overhead-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-overhead-exp.sh
cp run-overhead-exp.sh run-Lightning7_TEST-overhead-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-overhead-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-overhead-exp.sh
$HOME_PATH/tool.sh DATASET HouseTwenty_TEST run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.HouseTwenty" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-overhead-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-overhead-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-overhead-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 359994000 run-overhead-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 359994000 run-overhead-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-overhead-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-overhead-exp.sh
cp run-overhead-exp.sh run-HouseTwenty_TEST-overhead-exp.sh  # TODO check this

cd $HOME_PATH
cp $TRI_VISUALIZATION_EXP/bash/run-overhead-exp.sh .
$HOME_PATH/tool.sh HOME_PATH $HOME_PATH run-overhead-exp.sh
$HOME_PATH/tool.sh DATASET FreezerRegularTrain_TEST run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DEVICE "root.FreezerRegularTrain" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh MEASUREMENT "test" run-overhead-exp.sh # TODO check this
$HOME_PATH/tool.sh DATA_TYPE ${DATA_TYPE} run-overhead-exp.sh
$HOME_PATH/tool.sh TIMESTAMP_PRECISION ms run-overhead-exp.sh
$HOME_PATH/tool.sh DATA_MIN_TIME 1 run-overhead-exp.sh # TODO check this incremental t!!!
$HOME_PATH/tool.sh DATA_MAX_TIME 180580000 run-overhead-exp.sh  # TODO check this incremental t!!!
$HOME_PATH/tool.sh TOTAL_POINT_NUMBER 180580000 run-overhead-exp.sh
$HOME_PATH/tool.sh IOTDB_CHUNK_POINT_SIZE 100000 run-overhead-exp.sh
$HOME_PATH/tool.sh VALUE_ENCODING ${VALUE_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh TIME_ENCODING ${TIME_ENCODING} run-overhead-exp.sh
$HOME_PATH/tool.sh COMPRESSOR ${COMPRESSOR} run-overhead-exp.sh
cp run-overhead-exp.sh run-FreezerRegularTrain_TEST-overhead-exp.sh  # TODO check this
